...
\restrict uKiLpAaFASL270IruXfVbfiOi0ahUedldoJpNSENiJBr3kHHkLpRVyqdAgTItvB

-- Dumped from database version 18.1
-- Dumped by pg_dump version 18.1

-- Started on 2026-01-27 19:02:44
...
--
-- TOC entry 222 (class 1259 OID 17207)
...
--
-- TOC entry 221 (class 1259 OID 17206)
...
--
-- TOC entry 226 (class 1259 OID 17231)
...
ALTER SEQUENCE public.parroquias_id_parroquia_seq OWNER TO postgres;
...
--
-- TOC entry 4772 (class 2604 OID 17221)
...
--
-- TOC entry 4770 (class 2604 OID 17200)
...
--
-- TOC entry 4771 (class 2604 OID 17210)
...
--
-- TOC entry 4774 (class 2604 OID 17234)
...
--
-- TOC entry 4938 (class 0 OID 17218)
-- Dependencies: 224
-- Data for Name: ciudades; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.ciudades (id_ciudad, id_estado, ciudad, capital) FROM stdin;
1	1	Maroa	0
...
COPY public.estados (id_estado, estado, iso_3166_2) FROM stdin;
1	Amazonas	VE-X
2	Anzoátegui	VE-B
3	Apure	VE-C
4	Aragua	VE-D
...
--
-- TOC entry 4936 (class 0 OID 17207)
-- Dependencies: 222
-- Data for Name: municipios; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.municipios (id_municipio, id_estado, municipio) FROM stdin;
1	1	Alto Orinoco
2	1	Atabapo
3	1	Atures
4	1	Autana
...
--
-- TOC entry 4940 (class 0 OID 17231)
-- Dependencies: 226
...
SELECT pg_catalog.setval('public.ciudades_id_ciudad_seq', 522, true);
...
SELECT pg_catalog.setval('public.estados_id_estado_seq', 25, true);
...
SELECT pg_catalog.setval('public.municipios_id_municipio_seq', 462, true);
...
SELECT pg_catalog.setval('public.parroquias_id_parroquia_seq', 1138, true);


--
-- TOC entry 4781 (class 2606 OID 17228)
...
--
-- TOC entry 4776 (class 2606 OID 17205)
...
--
-- TOC entry 4779 (class 2606 OID 17215)
...
--
-- TOC entry 4785 (class 2606 OID 17239)
...
--
-- TOC entry 4782 (class 1259 OID 17229)
-- Name: idx_ciudades_id_estado; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_ciudades_id_estado ON public.ciudades USING btree (id_estado);


--
-- TOC entry 4777 (class 1259 OID 17216)
-- Name: idx_municipios_id_estado; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_municipios_id_estado ON public.municipios USING btree (id_estado);


--
-- TOC entry 4783 (class 1259 OID 17240)
-- Name: idx_parroquias_id_municipio; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_parroquias_id_municipio ON public.parroquias USING btree (id_municipio);


-- Completed on 2026-01-27 19:02:44

--
-- PostgreSQL database dump complete
--

\unrestrict uKiLpAaFASL270IruXfVbfiOi0ahUedldoJpNSENiJBr3kHHkLpRVyqdAgTItvB
