...
def crear_evento_pausado():
    ...
    print(f"   3. Verificar tarjeta 'Pausados / Cancelados' muestre: {total_pausados + total_cancelados}")
    print(f"   4. Verificar que el evento '{evento_pausado.nombre}' aparezca en la tabla con estado 'Pausado'")
