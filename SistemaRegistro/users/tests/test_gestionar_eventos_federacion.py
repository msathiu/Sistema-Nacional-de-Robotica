...
class GestionarEventosFederacionTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.user_inst = User.objects.create_user(
            username="user_inst", email="inst@test.com", password="test123"
        )
        ...
        self.profile_inst = UserProfile.objects.create(
            user=self.user_inst, user_type="institucional", institution=self.institucion
        )
    ...
    def test_logica_template_condicional(self):
        ...
        evento_fed_context = {"evento": self.evento_fed, "es_fed_central": True}

        evento_inst_context = {"evento": self.evento_inst, "es_fed_central": True}
        ...
        self.assertFalse(
            evento_fed_context["es_fed_central"]
            and evento_fed_context["evento"].institucion
        )
        ...
        self.assertTrue(
            evento_inst_context["es_fed_central"]
            and evento_inst_context["evento"].institucion
        )
