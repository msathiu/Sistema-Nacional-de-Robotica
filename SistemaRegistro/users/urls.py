...
urlpatterns = [
    ...
    # Participantes
    path(
        "participante/editar/<int:pk>/",
        views.ParticipanteUpdateView.as_view(),
        name="participante_editar",
    ),
    path("participantes/", views.lista_participantes, name="lista_participantes"),
    # Estadísticas
    path(
        "estadisticas/", views.estadisticas_por_estado, name="estadisticas_por_estado"
    ),
    # Eventos
