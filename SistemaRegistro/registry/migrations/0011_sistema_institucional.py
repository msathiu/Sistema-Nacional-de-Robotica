...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='grupo',
            name='codigo',
            field=models.CharField(default='GRP-00000000', editable=False, max_length=20),
        ),
        migrations.AddField(
            model_name='grupo',
            name='criterio',
        ...
        migrations.AddField(
            model_name='club',
            name='cupo_maximo',
            field=models.IntegerField(default=10, verbose_name='Cupo máximo de instituciones'),
        ),
        migrations.AddField(
            model_name='club',
            name='requisitos',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('club', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='membresias', to='registry.club')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('evento', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='inscripciones_grupo', to='registry.evento')),
                ('grupo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='inscripciones', to='registry.grupo')),
            ],
            options={
