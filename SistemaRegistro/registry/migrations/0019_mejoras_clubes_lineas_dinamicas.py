...
def migrar_lineas_existentes(apps, schema_editor):
    ...
    for orden, (codigo, nombre) in enumerate(lineas_map.items(), start=1):
        linea, created = LineaInvestigacion.objects.get_or_create(
            codigo=codigo, defaults={"nombre": nombre, "activa": True, "orden": orden}
        )
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["activa", "orden"], name="idx_linea_activa_orden"
            ),
        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        related_name="clubes",
                        to="registry.lineainvestigacion",
                    ),
                ),
            ],
            options={
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["club", "orden"], name="idx_clublinea_club_orden"
            ),
        ),
        ...
        migrations.RunPython(
            migrar_lineas_existentes, reverse_code=migrations.RunPython.noop
        ),
    ]
