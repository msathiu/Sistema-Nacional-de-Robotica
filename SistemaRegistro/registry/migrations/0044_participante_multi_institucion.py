...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['participante', 'status'], name='idx_partinst_part_st'),
        ),
        migrations.AddIndex(
            model_name='participanteinstitucion',
            index=models.Index(fields=['institucion', 'status'], name='idx_partinst_inst_st'),
        ),
        migrations.AddIndex(
            model_name='participanteinstitucion',
            index=models.Index(fields=['status', '-fecha_vinculacion'], name='idx_partinst_st_fecha'),
        ),
        migrations.AddIndex(
            model_name='participanteinstitucion',
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['participante', 'activo'], name='idx_partgrp_part_act'),
        ),
        migrations.AddIndex(
            model_name='participantegrupo',
