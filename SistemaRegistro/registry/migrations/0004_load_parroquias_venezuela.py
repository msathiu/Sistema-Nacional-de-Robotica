# Generated by Django 5.2.6 on 2026-02-07 03:57
...
def cargar_parroquias_venezuela(apps, schema_editor):
    ...
    # Formato: (id, municipio_id, nombre)
    parroquias = [
        (1, 1, "Alto Orinoco"),
    ...
    for par_id, mun_id, nombre in parroquias:
        # Buscamos el municipio al que pertenece la parroquia
        try:
            municipio_obj = Municipio.objects.get(id=mun_id)
            ...
            # Esto evita que la migración falle si un ID de municipio no existe
            print(
...
class Migration(migrations.Migration):
    dependencies = [
        ("registry", "0003_load_municipios_venezuela"),
    ]

    operations = [
        migrations.RunPython(cargar_parroquias_venezuela),
    ]
