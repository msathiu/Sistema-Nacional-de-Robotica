...
def cargar_municipios_venezuela(apps, schema_editor):
    ...
    # Definimos los municipios agrupados por el ID del estado que usaste en la migración anterior
    # Formato: (id_municipio, nombre_municipio, id_estado)
    municipios = [
        (1, 1, "Alto Orinoco"),
        (2, 1, "Atabapo"),
        (3, 1, "Atures"),
    ...
    for mun_id, estado_id, nombre in municipios:
        # Buscamos el objeto estado primero
...
class Migration(migrations.Migration):
    dependencies = [
        ("registry", "0002_load_estados_venezuela"),
    ]

    operations = [
        migrations.RunPython(cargar_municipios_venezuela),
    ]
