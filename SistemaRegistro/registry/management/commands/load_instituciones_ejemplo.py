...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        try:
            ...
            self.stdout.write(
                self.style.WARNING(
                    "Ejecuta primero: python manage.py load_venezuela_data"
                )
            )
            return
        ...
        instituciones = [
            ...
            # Grupos de Robótica
            {
                "nombre": "Club de Robótica UCV",
                "tipo": "GRUPO",
                "estado": dc,
                "municipio": libertador,
            },
            {
                "nombre": "Robótica Educativa USB",
                "tipo": "GRUPO",
                "estado": dc,
                "municipio": libertador,
            },
            {
                "nombre": "Grupo Robótica Juvenil Caracas",
                "tipo": "GRUPO",
                "estado": dc,
                "municipio": libertador,
            },
            {
                "nombre": "TecnoKids Venezuela",
                "tipo": "GRUPO",
                "estado": miranda,
                "municipio": chacao,
            },
            {
                "nombre": "Robotica Miranda",
                "tipo": "GRUPO",
                "estado": miranda,
                "municipio": baruta,
            },
            {
                "nombre": "Club de Robótica Valencia",
                "tipo": "GRUPO",
                "estado": carabobo,
                "municipio": valencia,
            },
            ...
            {
                "nombre": "Programadores del Futuro",
                "tipo": "GRUPO",
                "estado": dc,
                "municipio": libertador,
            },
            # Registro Individual
            {
                "nombre": "Registro Individual - Estudiante",
                "tipo": "INDIVIDUAL",
                "estado": dc,
                "municipio": libertador,
            },
            {
                "nombre": "Registro Individual - Profesional",
                "tipo": "INDIVIDUAL",
                "estado": miranda,
                "municipio": chacao,
            },
        ...
        for inst_data in instituciones:
            ...
            if created:
                count += 1
                self.stdout.write(
                    self.style.SUCCESS(f'✅ {inst_data["tipo"]}: {inst_data["nombre"]}')
                )
