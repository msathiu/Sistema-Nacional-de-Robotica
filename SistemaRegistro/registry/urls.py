...
urlpatterns = [
    ...
    # Eventos de Club - Admin/Federación
    path(
        "admin/eventos-club/revisar/",
        views_eventos.revisar_eventos_club,
        name="revisar_eventos_club",
    ),
    path(
        "admin/eventos-club/<int:evento_id>/aprobar/",
        views_eventos.aprobar_evento_club,
        name="aprobar_evento_club",
    ),
    path(
