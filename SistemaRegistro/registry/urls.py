...
urlpatterns = [
    ...
    path('grupos/<int:grupo_id>/editar/', views_institucional.editar_grupo, name='editar_grupo'),
    path('grupos/<int:grupo_id>/eliminar/', views_institucional.eliminar_grupo, name='eliminar_grupo'),
    
    # Eventos
    path('eventos/disponibles/', views_institucional.eventos_disponibles_institucion, name='eventos_disponibles_institucion'),
    path('eventos/<int:evento_id>/inscribir/', views_institucional.inscribir_grupo_evento, name='inscribir_grupo_evento'),
    ...
    path('clubes/<int:club_id>/postular/', views_institucional.postular_club, name='postular_club'),
    
    # API
    path('api/buscar-participante/', views_institucional.buscar_participante, name='buscar_participante'),
]
